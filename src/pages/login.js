        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          ...
          <div className="relative">
            <div className="mb-4 flex items-center gap-3">
              <button className="inline-flex items-center gap-2 rounded-full bg-[#7998F4] px-4 py-2 font-medium text-white ring-1 ring-green-200 transform transition-transform duration-200 hover:scale-105 ">
                ...
                <div className="flex items-center justify-center gap-3 py-3 z-20 relative">
                  {slides.map((s, i) => (
                    <button
                      key={s.id}
                      onClick={() => goTo(i)}
                      className={`h-2 w-2 rounded-full ${i === active ? "bg-[#7998F4]" : "bg-slate-300"}`}
