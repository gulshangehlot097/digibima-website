...
export default function WhyChooseUsSection() {
  ...
  const Card = ({ title, desc, shift = "", side, icon }) => (
    <div
      className={`relative w-full max-w-full sm:max-w-[360px] md:max-w-[420px] lg:max-w-[280px] mb-4 sm:mb-6 md:mb-8 ${shift}`}
    >
      <motion.div
      ...
      <div className="relative z-10">
        ...
        <div className="text-center mb-6 sm:mb-8 md:mb-12">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-800">
            Reasons to Choose <span className="text-[#0c4c8d]">DigiBima</span>
          </h2>
        </div>

        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-8 sm:gap-10">
          {/* Left cards */}
          <div className="flex flex-col justify-between items-center w-full lg:items-end lg:w-1/3 gap-4 sm:gap-6">
          ...
          >
            <Image
              ...
              width={420}
              height={420}
              className="w-40 h-40 sm:w-56 sm:h-56 md:w-64 md:h-64 lg:w-[420px] lg:h-[420px] object-contain"
              priority={false}
            />
          </motion.div>

          {/* Right cards */}
          <div className="flex flex-col justify-between items-center w-full lg:items-start lg:w-1/3 gap-4 sm:gap-6">
