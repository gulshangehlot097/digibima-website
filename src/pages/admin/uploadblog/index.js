...
import RichTextEditor from "./contenteditor";
...
function BlogUploadFormInner() {
  ...
  const [authors, setAuthors] = useState(["Anurag Pandya"]);
  ...
  return (
    <div className="relative min-h-screen ">
      ...
      <div className="mt-6 mb-16">
        <div className="max-w-6xl mx-auto px-4">
          <div className="rounded-2xl border bg-white/80 backdrop-blur shadow-xl ring-1 ring-black/5">
            <div className="flex items-center justify-between px-6 sm:px-8 py-4 border-b bg-gradient-to-r from-white to-sky-50/50 rounded-t-2xl">
            ...
            >
              ...
              <div className="lg:col-span-2 space-y-8">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-gray-300 bg-gray-50 px-4 py-3 shadow-sm outline-none focus:border-sky-400 focus:ring-2 focus:ring-sky-200"
                  />
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-gray-300 bg-gray-50 px-4 py-3 shadow-sm outline-none focus:border-indigo-400 focus:ring-2 focus:ring-indigo-200"
                  />
                  <p className="text-xs text-gray-500">
                    Example:{" "}
                    <span className="font-mono">best-health-plans</span>
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full rounded-xl border border-gray-300 bg-gray-50 px-4 py-3 shadow-sm outline-none focus:border-violet-400 focus:ring-2 focus:ring-violet-200"
                  />
                </div>
              ...
              <div className="space-y-8 lg:pl-2">
                <div className="space-y-3 rounded-xl border bg-white shadow-sm p-4">
                  ...
                  {preview ? (
                   <Image
                      ...
                      width={800}       
                      height={450}       
                      className="mt-3 aspect-[16/9] w-full rounded-lg border object-cover shadow-sm"
                      unoptimized        
                    />
                  ) : (
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2 pt-2">
                    <input
                      ...
                      className="flex-1 rounded-xl border border-gray-300 bg-gray-50 px-3 py-2 shadow-sm outline-none focus:border-sky-400 focus:ring-2 focus:ring-sky-200 text-sm"
                    />
                    <button
                      type="button"
                      onClick={addCategory}
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    value={formData.tags}
                    onChange={handleChange}
                    placeholder="e.g. insurance, health"
                    className="w-full rounded-xl border border-gray-300 bg-gray-50 px-4 py-3 shadow-sm outline-none focus:border-indigo-400 focus:ring-2 focus:ring-indigo-200"
                  />
                  <p className="text-xs text-gray-500">
                    Separate with commas:{" "}
                    <span className="font-mono">car, policy, renewal</span>
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2 pt-2">
                    <input
                      ...
                      className="flex-1 rounded-xl border border-gray-300 bg-gray-50 px-3 py-2 shadow-sm outline-none focus:border-violet-400 focus:ring-2 focus:ring-violet-200 text-sm"
                    />
                    <button
                      type="button"
                      onClick={addAuthor}
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full rounded-xl border border-gray-300 bg-gray-50 px-4 py-3 shadow-sm outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-200"
                  />
                </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 rounded-xl border bg-white shadow-sm p-4">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="rounded-lg border border-gray-300 bg-gray-50 px-3 py-2 text-sm shadow-sm outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-200"
                  >
              ...
              {/* Submit */}
              <div className="lg:col-span-3 border-t pt-6 flex flex-col sm:flex-row justify-end gap-3 sm:gap-4">
                <button
                  type="button"
